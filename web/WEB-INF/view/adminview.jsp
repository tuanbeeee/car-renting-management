        ...
        <section class="py-5">
            <div class="container-xl">
                ...
                <div class="table-responsive">
                    <%
                        String cusValid = (String) request.getAttribute("cusValid");
                        if (cusValid != null) {
                            ArrayList<ShoppingCart> sclst = (ArrayList<ShoppingCart>) request.getAttribute("cus");
                            if (sclst != null) { %>
                    <div class="table-wrapper">
                        ...
                        <table class="table table-striped table-hover" cellpadding="0" cellspacing="0" border="1" align="center" width="75%">
                            ...
                            <tbody>
                                <%
                                    for (ShoppingCart sc : sclst) {%>
                                <tr>
                                    <td><%=sc.getCar().getCarName()%></td> 
                                    <td><%=sc.getQuantity()%></td>
                                    <td><%=sc.getPickupDate()%></td>
                                    <td><%=sc.getReturnDate()%></td>
                                </tr>
                                <% } %>
                            </tbody>
                        </table>
                    ...
                    <%
                        String dateValid = (String) request.getAttribute("dateValid");
                        if (dateValid != null) {
                            ArrayList<ShoppingCart> dateCheck = (ArrayList<ShoppingCart>) request.getAttribute("date");
                            if (dateCheck != null) { %>
                    <div class="table-wrapper">
                        <div class="table-title">
                            <div class="row">
                        ...
                        <table class="table table-striped table-hover" cellpadding="0" cellspacing="0" border="1" align="center" width="75%">
                            ...
                            <tbody>
                                <%
                                    for (ShoppingCart sc : dateCheck) {%>
                                <tr>
                                    <td><%=sc.getCar().getCarName()%></td> 
                                    <td><%=sc.getQuantity()%></td>
                                    <td><%=sc.getPickupDate()%></td>
                                    <td><%=sc.getReturnDate()%></td>
                                    <td><%=sc.getRentID().getCustomerID().getFullname()%></td>
                                </tr>
                                <% } %>
                            </tbody>
                        </table>
